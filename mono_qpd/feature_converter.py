...
class InterpConverter(nn.Module):
    def __init__(self):
        ...
        self.channel_conv1 = nn.Conv2d(3072, 128, 1, stride=(1,1)) # For downsizing channels
        self.channel_conv2 = nn.Conv2d(3072, 128, 1, stride=(1,1))
        self.channel_conv3 = nn.Conv2d(3072, 128, 1, stride=(1,1))
