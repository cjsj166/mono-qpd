...
@dataclass
class Exp0916AdjustCLCRLRN132(BaseConfig):
...
@dataclass
class Exp0916AdjustCLCRLRN116(BaseConfig):
    num_steps: int = 200000
    batch_size: int = 4
    image_size: Tuple[int, int] = (448, 448)
    lr: int = 0.0002
...
@dataclass
class Exp0916AdjustCLCRLRN18(BaseConfig):
    num_steps: int = 200000
    batch_size: int = 4
    image_size: Tuple[int, int] = (448, 448)
    lr: int = 0.0002
