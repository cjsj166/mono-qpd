...
@dataclass
class LocalNoVolume(TrainConfig):
    num_steps: int = 200000
    batch_size: int = 1
    image_size: Tuple[int, int] = (448, 448)
    lr: int = 0.0002
...
@dataclass
class NoVolumeLRProduct(TrainConfig):
    num_steps: int = 200000
    batch_size: int = 4
    image_size: Tuple[int, int] = (448, 448)
    lr: int = 0.0002
...
@dataclass
class LocalNoVolumeLRProduct(TrainConfig):
    num_steps: int = 200000
    batch_size: int = 1
    image_size: Tuple[int, int] = (448, 448)
    lr: int = 0.0002
...
@dataclass
class AllPairsLRProduct(TrainConfig):
    num_steps: int = 200000
    batch_size: int = 4
    image_size: Tuple[int, int] = (448, 448)
    lr: int = 0.0002
...
@dataclass
class LocalAllPairsLRProduct(TrainConfig):
    num_steps: int = 200000
    batch_size: int = 1
    image_size: Tuple[int, int] = (448, 448)
    lr: int = 0.0002
...
@dataclass
class VolumeCLCRFeatureCLCRLR(TrainConfig):
    num_steps: int = 200000
    batch_size: int = 4
    image_size: Tuple[int, int] = (448, 448)
    lr: int = 0.0002
...
@dataclass
class LocalVolumeCLCRFeatureCLCRLR(TrainConfig):
    num_steps: int = 200000
    batch_size: int = 1
    image_size: Tuple[int, int] = (448, 448)
    lr: int = 0.0002
